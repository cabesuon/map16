require([
  ...
  function popupTemplateContentAttrTable(attrs) {
    ...
    + `<tr><td>${safeAttrValue(attrs.CAMERA_EMBED)}</td></tr>`
    + `</tbody></table>`;
  }
  ...
  const popupTemplate = {
    ...
    outFields: [
      'CAMERA_ID', 'CAMERA_EMBED', 'DAM_AREA', 'POSTCODE', 'THOROUGHFARE', 'TOWN', 'sensor_url'
    ]
  };
  ...
  const layer = new FeatureLayer({
    ...
    outFields: [
      'CAMERA_ID', 'CAMERA_EMBED', 'postcode', 'road', 'sd_number', 'alert_level', 'sensor_url'
    ],
